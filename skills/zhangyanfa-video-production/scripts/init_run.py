...
SUBDIRS = ("narration", "captions", "visuals/contact_sheets", "audio", "qa")
...
def main() -> int:
    ...
    if not plan_path.exists():
        plan = {
            "checks": [
                {"id": "request_contract_exists", "type": "file_nonempty", "path": "request_contract.json"},
                {"id": "run_manifest_exists", "type": "file_nonempty", "path": "run_manifest.json"},
                {"id": "edit_ledger_exists", "type": "file_nonempty", "path": "edit_ledger.tsv"},
                {"id": "batch_ledger_exists", "type": "file_nonempty", "path": "batch_ledger.tsv"},
                {
                ...
                {"id": "acceptance_report_exists", "type": "file_nonempty", "path": "acceptance_report.md"},
            ]
        }
